 ...
 *
 * Shared testData lives at `fusio-compiler-plugin-tests/testData/` (box +
 * diagnostics); IR goldens that differ per compiler version live in this
 * module's own `testData/ir/`. `generateTestsK24` below writes its test-gen
 * alongside the k24-specific runners.
 */
